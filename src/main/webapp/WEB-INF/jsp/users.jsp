            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr class="${user.id}">
                    ...
                    <td><input type="checkbox"
                               <c:if test="${user.enabled}">checked</c:if> id="${user.id}" onclick="changeEnableState(${user.id})"/></td>
                    <td><fmt:formatDate value="${user.registered}" pattern="dd-MMMM-yyyy"/></td>
                    <td><a><span class="fa fa-pencil"></span></a></td>
                    <td><button onclick="deleteRow(${user.id})"><span class="fa fa-remove"></span></button></td>
                </tr>
            </c:forEach>
        </table>
    </div>
